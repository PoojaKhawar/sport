...
<div class="dropdown-menu dropdown-menu-end">
	<form action="{{ route('admin.blogs.categories') }}" id="filters-form">
		<a href="javascript:;" class="float-end px-2 closeit">
			<i class="fa fa-times-circle"></i>
		</a>
		{{-- <div class="dropdown-item">
			<div class="form-group mb-0">
				<label class="form-label">{{ Setting::get('sub_category_enable') ? 'Parent Category' : 'Category' }}</label>
				<select class="select2 form-select" name="category[]" data-placeholder="Nothing selected" multiple>
		...
		<div class="dropdown-bottom clearfix">
			<a href="{{ route('admin.blogs.categories') }}" class="btn btn-sm btn-danger px-3 float-start">Reset All</a>
