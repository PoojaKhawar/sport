				          	...
				          	<table class="table listing-table">
				            	<thead class="thead-light">
					              	<tr>
										...
										<th class="sort">
											Name
											@if(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.first_name' && isset($_GET['direction']) && $_GET['direction'] == 'asc')
											<i class="fas fa-sort-down active" data-field="contact_us.first_name" data-sort="asc"></i>
											@elseif(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.first_name' && isset($_GET['direction']) && $_GET['direction'] == 'desc')
										...
										<th class="sort">
											Subject
											@if(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.subject' && isset($_GET['direction']) && $_GET['direction'] == 'asc')
											<i class="fas fa-sort-down active" data-field="contact_us.subject" data-sort="asc"></i>
											@elseif(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.subject' && isset($_GET['direction']) && $_GET['direction'] == 'desc')
											<i class="fas fa-sort-up active" data-field="contact_us.subject" data-sort="desc"></i>
											@else
											<i class="fas fa-sort" data-field="contact_us.subject"></i>
											@endif
										</th>
										{{-- <th class="sort">
											Status
											@if(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.status' && isset($_GET['direction']) && $_GET['direction'] == 'asc')
											<i class="fas fa-sort-down active" data-field="contact_us.status" data-sort="asc"></i>
											@elseif(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.status' && isset($_GET['direction']) && $_GET['direction'] == 'desc')
											<i class="fas fa-sort-up active" data-field="contact_us.status" data-sort="desc"></i>
											@else
											<i class="fas fa-sort" data-field="contact_us.status"></i>
											@endif
										</th> --}}
										<th class="sort">
											Created ON
