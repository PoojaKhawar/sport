		...
		<div class="row">
			...
			<div class="col-lg-6 col-5">
				<div class="right_area text-right filter-dropdown">
					...
					<a href="{{ route('admin.states.add') }}" class="btn btn-default me-1">New</a>
					@endif
				...
				<div class="card listing-block">
			        <div class="card-header">
						...
						<div class="actions">
		                    ...
		                    @if(Permission::hasPermission('states', 'update') || Permission::hasPermission('states', 'delete'))
		                    <div class="action_dropdown btn-group">
		                    	...
		                    	<ul class="dropdown-menu dropdown-menu-end">
		                    		...
		                    		<li>
		                            	...
		                            	onclick="bulk_actions('{{ route('admin.states.bulkActions', ['action' => 'active']) }}', 'active');">
		                    		...
		                    		<li>
		                    			<a class="dropdown-item" href="javascript:;" 
		                            	onclick="bulk_actions('{{ route('admin.states.bulkActions', ['action' => 'inactive']) }}', 'inactive');">
		                    		...
		                    		<li>
		                    			<a class="dropdown-item" href="javascript:;" 
		                            	onclick="bulk_actions('{{ route('admin.states.bulkActions', ['action' => 'delete']) }}', 'delete');">
